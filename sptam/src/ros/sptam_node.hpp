...
class sptam_node
{
  ...
  // Method variables
    tf::Transform Boreas_groundtruth_pose;
    struct Point_2d{
        double X;
        double Y;
    };
    ...
    Point_2d current_ground_truth_old;
    Point_2d current_ground_truth_new;
  ...
  // ROS variables
    ros::Publisher mapPub_, posePub_, localizationErrorPub_;
    ros::Subscriber Boreas_groundtruth_sub;
