...
//  std::cout<<"left keypoints "<<unmatchedKeypointsLeft.size()<<std::endl;
//  std::cout<<"right keypoints "<<unmatchedKeypointsRight.size()<<std::endl;
...
)
{
  ...
  std::cout<<keypointsLeft.size()<<std::endl;
  std::cout<<cvMatches.size()<<std::endl;
